...
export const selectRunState = [{label:'处理中',value:'processing'},{label:'运行中',value:'running'},{label:'已停止',value:'stopped'},{label:'创建中',value:'creating'},
{label:'启动中',value:'starting'},{label:'停止中',value:'stopping'},{label:'故障恢复中',value:'fault-resuming'}]
