    ...
    <div
      ...
      <div id="tableSale2" style='width: 90%;margin:30px auto 0 '>
        <el-table :data="resourceData" border style="width: 100%" :header-cell-style="{'text-align':'center'}" :cell-style="{'text-align':'center'}"
          ...
          <el-table-column prop="count" label="已清退桌面数">
          </el-table-column>
        </el-table>
        <div class="block">
          <el-pagination layout="prev, pager, next" :total="total2" :current-page="currentPage2" :page-size="10"
