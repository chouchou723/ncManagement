      ...
      <div class="box">
        ...
        <el-form :model="params" :rules="rules2" ref="params" label-position="left">
          <el-form-item label="秘钥:" :label-width="formLabelWidth" prop="secretKey">
            <el-input style="width:180px;" type="text" v-model="params.secretKey" placeholder="请输入秘钥"
              :style='{width:inputLabelWidth}' />
          </el-form-item>
          <el-form-item label="邮箱:" :label-width="formLabelWidth" prop="email">
            <el-input style="width:180px;" type="email" v-model="params.email" placeholder="请输入接收随机密码的邮箱"
              :style='{width:inputLabelWidth}' />
          </el-form-item>
          <br />
