      ...
      <div class="box">
        ...
        <el-form :model="params" :rules="rules2" ref="params" label-position="left" >
          <!-- <el-form-item label="原密码:" :label-width="formLabelWidth" prop="initialPassword" >
            <el-input  type="password" v-model="params.initialPassword" placeholder="请输入原密码" :style='{width:inputLabelWidth}' autocomplete="new-password" />
          </el-form-item> -->
          <el-form-item label="新密码:" :label-width="formLabelWidth" prop="newPwd">
            <el-input  type="password" v-model="params.newPwd" placeholder="请输入新密码" :style='{width:inputLabelWidth}' autocomplete="new-password" clearable/>
          </el-form-item>
          <el-form-item label="确认新密码:" :label-width="formLabelWidth" prop="newPwdConfirm">
            <el-input  type="password" v-model="params.newPwdConfirm" placeholder="请确认新密码" :style='{width:inputLabelWidth}' autocomplete="new-password" clearable/>
          </el-form-item>
          <br/>
...
<script>
  ...
  export default {
    ...
    var validatePass = (rule, value, callback) => {
        ...
        //   }
          if (this.params.newPwdConfirm !== '') {
            this.$refs.params.validateField('newPwdConfirm');
          }
          callback();
        }
      }
