  ...
  export default {
    ...
    //   },
      ...
      postpone() { //点击新增
        ...
        let url = `desktop/clouderNotWhitelist?${Math.random()}&online=1&page=${this.currentPage5}&limit=${this.currentSize1}&computerName=${this.queryUserName}&user=${this.queryuser}`
