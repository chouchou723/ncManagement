<template>
  <div id="adminTicketFailed">
    <div class="search-wrap">
      ...
      <el-input placeholder="请输入桌面名称" style="width:185px;" clearable v-model="applyUser"  @keyup.enter.native="clearData" @clear="clearData(1)">
      </el-input>
    ...
    <div class="table-wrap" id="table-wrap">
      <el-table :data="tableData" v-loading="vmTableLoadingState" :height="tableHeight" stripe ref="multipleTable"
        ...
        <el-table-column label="操作" width="220">
          <template slot-scope="scope">
            <el-button @click="handleClickRestart(scope.row)" type="primary" size="small"
              :loading="btnLoading&&(btnIndex==scope.row.id)">重新发起</el-button>
        ...
        <!-- <el-table-column label="操作" width="100">
          <template slot-scope="scope">
            <el-button @click="handleClickRestart(scope.row)" type="text" size="small" :loading="btnLoading&&(btnIndex===scope.row.id)">{{btnLoading&&(btnIndex===scope.row.id)?'发起中':'重新发起'}}</el-button>
          </template>
        </el-table-column> -->
      </el-table>
