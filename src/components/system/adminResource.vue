  ...
  <div id="adminResource" v-loading.fullscreen="loadingState" :element-loading-text="text">
    ...
    <div class="table-wrap" id="table-wrap">
      <el-table ref="multipleTable" :data="tableData" v-loading="vmTableLoadingState" :height="tableHeight"
        ...
        <el-table-column prop="user" label="使用人"  min-width="100">
        </el-table-column>
        <el-table-column prop="computerName" label="桌面名称"  :min-width="150">
         ...
         <el-table-column prop="operatorAccount" label="所属管理员">
        </el-table-column>
  ...
  export default {
    ...
    //   },
      ...
      getVmList(first,page) {
        ...
        const url = `desktop/adminResMonitor?${Math.random()}`
      ...
      getStatistics() {
        const url = 'desktop/adminStatistics?'
