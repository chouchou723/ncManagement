    ...
    <div class="table-wrap" id="table-wrap">
      <div class="newBtnWrap">
        <el-button-group>
          ...
          <!-- <el-button size="small" type="primary" @click="resourceForm=true" icon="el-icon-sort">资源转移</el-button> -->
    ...
    <el-dialog title="消息记录" :visible.sync="dialogMessage" :close-on-click-modal="no" custom-class='accountManageDialog'
      ...
      <!-- <div slot="footer" class="dialog-footer">
        <el-button type="primary" :loading="btnLoading" :disabled="multSelectionTran.length===0"
          @click="confirmTagUser">确
          定</el-button>
        <el-button @click="消息列表 = false">取 消</el-button>
      </div> -->
    </el-dialog>
    <!-- 点击标签发送消息  -->
...
applyOu:[]
    ...
    methods: {
      ...
      exportData() {
        window.open('/dcp/user/exportData')
      },
