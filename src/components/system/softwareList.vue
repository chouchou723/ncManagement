<template>
  <div id="userOnlineSupport">
    <div class="search-wrap">
      <el-input placeholder="请输入软件名称" style="width:185px;" clearable v-model="applyUser" @keyup.enter.native="clearData"
        @clear="clearData(1)">
      </el-input>
    ...
    <div class="table-wrap" id="table-wrap">
      <el-table :data="tableData" v-loading="vmTableLoadingState" :height="tableHeight" @select="checkSelect" stripe
        ...
        <el-table-column prop="faName" label="软件名称">
        </el-table-column>
        <el-table-column prop="faIP" label="软件版本">
        </el-table-column>
        <el-table-column prop="faBackupIp" label="申请总数">
        </el-table-column>
        <el-table-column prop="virtualNum" label="已申请数">
        </el-table-column>
        <el-table-column prop="virtualNum" label="可申请数">
        </el-table-column>
    ...
    <!-- 新增 -->
    <el-dialog :title="faId?'修改软件':'新增软件'" :visible.sync="dialogFormVisible"
      :close-on-click-modal="no" custom-class='accountManageDialog' top='10%' @close='resetD("aform")' width="50%">
      <!-- <el-scrollbar wrap-class="scrollbar-wrapper" id="menuList123" ref="myScrollbar"> -->
        <el-form :model="aform" :rules="rules2" ref="aform">
          <el-form-item label="软件名称：" :label-width="formLabelWidth" prop="faName">
            <el-input v-model="aform.faName" placeholder='请输入软件名称' :style='{width:inputLabelWidth}'>
            </el-input>
          </el-form-item>
          <el-form-item label="软件版本：" :label-width="formLabelWidth" prop="faIP">
            <el-input v-model="aform.faIP" placeholder='请输入软件版本' :style='{width:inputLabelWidth}' :readonly="faId!==''">
            </el-input>
          </el-form-item>
 <el-form-item label="可申请总数：" :label-width="formLabelWidth" prop="virtualNum">
