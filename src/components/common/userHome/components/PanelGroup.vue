<template>
  <el-row class="panel-group"
    style="display:flex;align-items:center;height:70%;width: 100%;justify-content: space-between;margin-bottom: 5%;">
    <div class="card-panel-col">
        <div style="position:absolute;top:-12%;font-size: 24px;color:#666;font-weight: 600">快捷菜单</div>
      <div class="card-panel" @click="handleSetLineChartData('/desktopApply')" style="background: #34bfa3;">
        ...
        <!-- <img src="../../../../assets/img/applyDesk.png" alt="" style="max-width:200px;"> -->
    ...
    <div class="card-panel-col" style="margin-top:15%">
      <div class="card-panel" @click="handleSetLineChartData('/myOrder')" style="background:#ff8600">
    ...
    <div class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('/myDesk')" style="background:#ea402d">
    ...
    <div class="card-panel-col" style="margin-top:15%">
      <div class="card-panel" @click="handleSetLineChartData('online')" style="background:#36a3f7">
        ...
        <div class="card-panel-description" style="position:relative">
          在&nbsp;线&nbsp;帮&nbsp;助
          <div style="position: absolute;bottom: -15px;font-size:12px;width: 100%;text-align: center;color:#ddded8"
...
<style rel="stylesheet/scss" lang="scss" scoped>
  .panel-group {
    ...
    .card-panel-col {
      height: 100%;
      flex: 0 0 20% //   margin-bottom: 32px;
    }
