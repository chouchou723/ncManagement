...
//   var websocket;
  export default {
    ...
    //       return `ws://172.16.6.18:9090/api/webSocketServer?userName=${this.username}`;
    //     } else {
    //       return `ws://${window.location.host}/api/webSocketServer?userName=${this.username}`;
    //     }
    //   }
    },
    mounted() {
    ...
    //         upload: '/api/bigFile/uploadSlice',
    //         query: '/api/bigFile/querySlice',
    //         merge: '/api/bigFile/findBigFile',
    //         cache: false,
    //         thread: 1, // 线程数
    ...
    //       layim.config({
    //         uploadImage: {
    //           url: '/api/uploader/layimUpload?type=chat'
    //         },
    //         init: {
    //           mine: { //配置发送者的信息
    ...
    //     // // let url = `ws://172.16.5.231:9090/api/webSocketServer?userName=${this.username}`;
    //     // let url =`ws://${window.location.host}/api/webSocketServer?userName=${this.username}`;
    //     // if(!websocket){
    ...
    //     //     if (!this.websocket) {
    //     //       if ('WebSocket' in window) {
    //     //         this.websocket = new WebSocket("ws://" + window.location.host + "/api/webSocketServer");
    //     //       } else if ('MozWebSocket' in window) {
    //     //         this.websocket = new MozWebSocket("ws://" + window.location.host + "/api/webSocketServer");
    //     //       }
    //     //       that.initIm();
    //     //       this.websocket.onmessage = function (res) {
    //     //         /*  if(typeof res.data=== String){
