<template>
  <div class="dashboard-editor-container">
    ...
    <!-- 故障详情 -->
    <el-dialog title="故障详情" :visible.sync="modelProblem" custom-class='accountManageDialog' :close-on-click-modal="no" top='5%' width="40%"
    ...
    <el-dialog title="选择处理人" :visible.sync="modalState1" :close-on-click-modal="no" custom-class='accountManageDialog'
      ...
      <div class="table-wrap" id="table-wrap">
        <el-table :data="userListData" height="260" ref="multipleTable" stripe @row-click="rowClickSys"
