<template>
  <el-row class="panel-group"
    ...
    <div class="card-panel-col">
      ...
      <div class="card-panel" @click="handleSetLineChartData('/cloudOnline')" style="background: #34bfa3;">
        ...
        <div class="card-panel-description">在&nbsp;线&nbsp;资&nbsp;源
    ...
    <div class="card-panel-col" style="margin-top:15%">
      <div class="card-panel" @click="handleSetLineChartData('/cloudApplied')" style="background:#ff8600">
    ...
    <div class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('/cloudFailed')" style="background:#ea402d">
    ...
    <div class="card-panel-col" style="margin-top:15%">
      <div class="card-panel" @click="handleSetLineChartData('/merchandiseSetting')" style="background:#36a3f7">
...
<style rel="stylesheet/scss" lang="scss" scoped>
  .panel-group {
    ...
    .card-panel-col {
      height: 100%;
      flex: 0 0 23% //   margin-bottom: 32px;
    }
