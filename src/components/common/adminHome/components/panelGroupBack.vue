  ...
  <div>
    ...
    <el-row :gutter="40" class="panel-group">
      <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('/adminOnline')">
      ...
      <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col">
        <div class="card-panel" @click="handleSetLineChartData('/adminOrders')">
      ...
      <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col ">
        <div class="card-panel" @click="handleSetLineChartData('deskConfig')">
    ...
    <el-row :gutter="40" class="panel-group">
      ...
      <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col hidden-mid-and-down">
        <div class="card-panel" @click="handleSetLineChartData('/adminTicket')">
      ...
      <el-col :xs="12" :sm="12" :lg="8" class="card-panel-col hidden-mid-and-down">
        <div class="card-panel" @click="handleSetLineChartData('/adminRecyle')">
